...
import static personspace.ProjectConstant_Client.*;
...
public class ClientCodeGenerator {
    ...
    private static final String TEMPLATE_FILE_PATH = TEMPLATE_PATH + "/src/test/resources/generator/template";//模板位置
