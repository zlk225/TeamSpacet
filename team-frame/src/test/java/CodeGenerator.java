...
import personspace.ProjectConstant_Client1;
...
import static personspace.ProjectConstant_Client1.*;
...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/person_space?characterEncoding=UTF-8&serverTimezone=UTC&useSSL=false";
    private static final String JDBC_USERNAME = "root";
    private static final String JDBC_PASSWORD = "root";
    private static final String JDBC_DIVER_CLASS_NAME = "com.mysql.jdbc.Driver";

    private static final String PROJECT_PATH = System.getProperty("user.dir") + "/team-frame";//项目在硬盘上的基础路径
    private static final String TEMPLATE_PATH = System.getProperty("user.dir") + "/team-frame";//模板在硬盘上的基础路径
    private static final String TEMPLATE_FILE_PATH = PROJECT_PATH + "/src/test/resources/generator/clientTemplate";//模板位置
    ...
    private static final String AUTHOR = "zlk";//@author
...
//        genController(tableName, modelName);
    ...
    public static void genModelAndMapper(String tableName, String modelName) {
        ...
        pluginConfiguration.setConfigurationType("personspace.PaginationPlugin");
...
//        javaTypeResolverConfiguration.setConfigurationType(ProjectConstant.BASE_PACKAGE+".JavaTypeResolverDefault");
...
//        commentGenerator.addProperty("suppressAllComments", "true");
        ...
        commentGeneratorConfiguration.setConfigurationType("personspace.GenCommentGenerator");
