...
public class UUID implements Serializable, Comparable {
	...
	public static void main(String[] args) {
		...
		List<UUID> myList = IntStream.range(0, 10000000).parallel().mapToObj((i) -> UUID.randomUUID()).collect(Collectors.toList());
		removeDuplicateObj(myList);
	...
	public static String getRandNumber1(int number) {
